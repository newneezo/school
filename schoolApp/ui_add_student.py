...
class Ui_add_student(object):
    def setupUi(self, add_student):
        ...
        add_student.resize(486, 498)
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(add_student)
        ...
        self.tabWidget = QtWidgets.QTabWidget(add_student)
        font = QtGui.QFont()
        ...
        self.sddress.setObjectName("address")
    ...
    def retranslateUi(self, add_student):
        ...
        self.label.setText(_translate("add_student", "اضافة طالب جديد"))
        self.label_2.setText(_translate("add_student", "الاسم : "))
        self.label_3.setText(_translate("add_student", "العنوان : "))
        self.label_4.setText(_translate("add_student", "تاريخ الميلاد : "))
        self.label_5.setText(_translate("add_student", "اسم ولي الامر : "))
        self.label_6.setText(_translate("add_student", "عمل ولي الامر : "))
        self.label_7.setText(_translate("add_student", "هاتف ولي الامر : "))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_personalData), _translate("add_student", "البيانات الشخصية"))
        self.label_8.setText(_translate("add_student", "مدرسة الاساس : "))
        self.label_9.setText(_translate("add_student", "المجموع : "))
        self.label_10.setText(_translate("add_student", "الصف : "))
        self.label_11.setText(_translate("add_student", "الرسوم الدراسية : "))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_school_data), _translate("add_student", "البيانات المدرسية"))
        self.pushButton.setText(_translate("add_student", "حفظ"))
